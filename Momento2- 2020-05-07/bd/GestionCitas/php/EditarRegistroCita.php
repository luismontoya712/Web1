<?php
	...
	function ModificarCita($id,$nom,$apell,$doc,$Fecnac,$ciu,$barr,$dir,$tel,$feccit,$med)
	{
		...
		try
		{
			...
			if($result)
			{
                echo'<script language="javascript">alert("Cita Modificada Exitosamente ");window.location.href="../frmApp/consultarcitas.php"</script>';         
            }  

		}
		catch( Exception $ex)
		{
			die('<script language="javascript">alert("Error de Actualizacion de Cita");window.location.href="../frmApp/crearcitas.php"</script>'); 
		} 
