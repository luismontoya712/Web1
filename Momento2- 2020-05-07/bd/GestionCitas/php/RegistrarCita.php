   ...
   (!isset($_POST['idMedico'])) )
{
    ...
    {
        die('<script language="javascript">alert("El documento Debe Ser Numerico");window.location.href="../frmApp/crearcitas.php"</script>');
    }
    ...
    {
        die('<script language="javascript">alert("El Telfono Celular Debe Ser Numerico");window.location.href="../frmApp/crearcitas.php"</script>');
    }

    $longitudTelefono = strlen ($telefono); 
    if ($longitudTelefono <> 10)
    {
         die('<script language="javascript">alert("El Numero de Telefono debe ser de 10 Digitos");window.location.href="../frmApp/crearcitas.php"</script>');
    }
    ...
    try
    {
        ...
        {
            echo'<script language="javascript">alert("Ya Exite  Una Cita Programada para La fecha y hora Digitada");window.location.href="../frmApp/crearcitas.php"</script>';
        }
        else
        {
            ...
            if($result)
            {
                 echo'<script language="javascript">alert("Cita Programda Exitosamente ");window.location.href="../frmApp/crearcitas.php"</script>';         
            }  
        }     
    }
    catch (Exception $ex)     
    {
        die('<script language="javascript">alert("Error de Regitro de Cita");window.location.href="../frmApp/crearcitas.php"</script>'); 
    } 
